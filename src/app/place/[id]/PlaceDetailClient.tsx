            ...
            <div style={{ display:"flex", gap:"8px", overflowX:"auto", paddingBottom:"6px", scrollbarWidth:"thin", scrollbarColor:"#ddd transparent" }}>
              {allGalleryImages.map((img, idx) => (
                <div key={img.id} style={{ position:"relative", flexShrink:0, width:"130px", height:"130px" }}>
                  <div onClick={() => { setSelectedImage(img.image_url); setSelectedImageIndex(idx); }} style={{ cursor:"pointer", width:"100%", height:"100%", borderRadius:"12px", overflow:"hidden", border:"1px solid #eee", position:"relative" }}>
                    <Image src={img.image_url} alt="장소 이미지" fill sizes="130px" style={{ objectFit:"cover" }} priority={idx === 0} />
                  </div>
                ...
                <div key={r.id} style={{ borderBottom:"1px solid #eee", padding:"10px 0" }}>
                  ...
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                    <div style={{ display:"flex", alignItems:"center", gap:"6px" }}>
                      <div style={{ width:"24px", height:"24px", borderRadius:"50%", background:getProfileColor(r.nickname), color:"white", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"11px", fontWeight:700, flexShrink:0, overflow:"hidden", position:"relative" }}>
