...
export default function AdminTipsPage() {
  ...
  return (
    <>
      ...
      <div className="ggk-body" style={{ display:"flex", flexDirection:"column", height:"100vh", background:"#f0f2f5", overflow:"hidden" }}>
                ...
                <div style={{ padding:"14px 16px" }}>
                  ...
                  {(tip.content || tip.report_reason || tip.description) && (
                    <div style={{
                      ...
                      borderRadius:10, border:"1px solid #eee", marginBottom:12,
                    }}>
